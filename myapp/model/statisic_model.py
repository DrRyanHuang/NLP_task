...
class SentiDict():
    ...
    def init_dicts(self):
        senti_path = "myapp/data/sentiment_dictionary/sentiment_dict_en_1.txt"
        # senti_path = "myapp/data/sentiment_dictionary/DictionaryIMDB.csv"
        adv_path = 'myapp/data/sentiment_dictionary/adv.txt'
        non_path = "myapp/data/sentiment_dictionary/non.txt"
